...
public class Controlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (menu.equals("Calculadora1")) {
            request.getRequestDispatcher("calculadora1.jsp").forward(request, response);
        }
        if (menu.equals("Calculadora2")) {
            request.getRequestDispatcher("calculadora2.jsp").forward(request, response);
        }
        if (menu.equals("Calculadora3")) {
            request.getRequestDispatcher("calculadora3.jsp").forward(request, response);
        }
        if (menu.equals("Calculadora4")) {
            request.getRequestDispatcher("calculadora4.jsp").forward(request, response);
        }
        if (menu.equals("Calculadora5")) {
            request.getRequestDispatcher("calculadora5.jsp").forward(request, response);
        }
        if (menu.equals("Calculadora6")) {
            request.getRequestDispatcher("calculadora6.jsp").forward(request, response);
        }
