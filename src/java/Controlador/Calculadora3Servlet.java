...
@WebServlet(name = "Calculadora3Servlet", urlPatterns={"/Calculadora3Servlet"})
public class Calculadora3Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        int pinonConducido = Math.round((pinonMotriz * rpmMotor ) / rpmDeseadas);
        ...
        out.println("<h4 class=\"page-title text-center\">Calculadora de número de dientes del piñón conducido</h4>");
        ...
        out.println("<strong>RESPUESTA<br><br>Usted necesita un piñón conducido de  " + pinonConducido + " dientes, de acuerdo con los datos ingresados</strong></div>");
        out.println("Si necesita cotizar escríbanos:<br><br>");
        out.println("<a href=\"https://api.whatsapp.com/send?phone=51960635895&text=Quiero%20cotizar%20un%20pinon%20de%20"+ pinonConducido +"%20dientes%20para%20pinon%20conducido\" target=\"_blank\">");
