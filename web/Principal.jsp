        ...
        <div class="wrapper">
            ...
            <!-- Header principal -->    
                <div class="main-header">
                    ...
                    <div class="logo-header" >
                        <a href="#" class="logo">
                            <img src="assets/img/logoMecaColor.svg" alt="Mecadustria En-Línea" class="adml navbar-brand">
                        </a>
                                    ...
                                    <ul class="nav">
                                       <!--     <li>
                                        ...
                                        <li>
                                            <div class="dropdown-divider"></div>
                                            <form action="Validar" method="POST">
                                                <button name="accion" class="dropdown-item" value="Salir">Salir</button>
                                            </form>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse" id="tables">
                                    <ul class="nav nav-collapse">
                                        <li>
                                            <a href="Controlador?menu=Calculadora1" target="myFrame">
                                                <span class="sub-item">Longitud de cadena</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="Controlador?menu=Calculadora2" target="myFrame">
                                                <span class="sub-item">Piñón motriz</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="Controlador?menu=Calculadora3" target="myFrame">
                                                <span class="sub-item">Piñón conducido</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="Controlador?menu=Calculadora4" target="myFrame">
                                                <span class="sub-item">RPM salida</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="Controlador?menu=Calculadora5" target="myFrame">
                                                <span class="sub-item">Seleccionar Cadena</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="Controlador?menu=Calculadora6" target="myFrame">
                                                <span class="sub-item">Seleccionar Acople</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="main-panel row h-100">
                <div class="my-auto mx-auto">
                    <img src="assets/img/logoMecaColor.png" alt=""/>
                </div>
