...
<html lang="es">
    ...
    <body>
            ...
            <div class="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <br />
                            <h4 class="page-title text-center"><strong>Calculadora de cadena idónea</strong> </h4>
                            <div class="card-header text-center">
                                <div class="align-items-center">
                                    <div class="card-title">Determine la cadena idónea para su sistema</div>
                                </div>
                                <br />
                                <div class="border-top border-dark border-1">
                                    <div class="col">
                                        ...
                                        <br>
                                        <form action="Calculadora5Servlet" method="post">
                                        <div class="mx-5 my-3">
                                            <label class="text-left">Tipo de motor</label>
                                            <select class="form-control input-solid" name="motor" id="motor" required="">
                                                <option value="1">Motor de combustión interna con acoplamiento hidráulico</option>
                                                <option value="2">Motores eléctricos y turbinas</option>
                                                <option value="3">Motor de combustión interna con acoplamiento mecánico</option>
                                            </select>
                                        </div>
                                        <div class="mx-5 my-3">
                                            <label class="text-left">Tipo de carga</label>
                                            <select class="form-control input-solid" name="carga" id="carga" required="">
                                                <option value="1">Carga uniforme</option>
                                                <option value="2">Carga con choques moderados</option>
                                                <option value="3">Carga con choques fuertes</option>
                                            </select>
                                        </div>
                                        <div class="mx-5 my-3">
                                        ...
                                        <div class="mx-5 my-3">
                                            <label class="text-left"># dientes del piñón motriz</label>
                                            <select class="form-control input-solid" name="pinonMotriz" id="pinonMotriz" required="">
                                                <option value="17">17 dientes</option>
                                                <option value="19">19 dientes</option>
                                            </select>
                                        </div>    
        ...
        <script>
            ...
            var pinonMotriz = document.getElementById("pinonMotriz");
            ...
            function calcular() {
                ...
                resultadoOperacion = (parseInt(potenciaMotor.value) * (CARGA_A[parseFloat(carga.value)] * MOTOR_A[parseFloat(motor.value)] * PINON[parseFloat(pinonMotriz.value)]));
