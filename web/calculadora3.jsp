...
<html lang="es">
    ...
    <body>
            ...
            <div class="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <br />
                            <h4 class="page-title text-center"><strong>Calculadora de número de dientes del piñón conducido</strong> </h4>
                            <div class="card-header text-center">
                                <div class="align-items-center">
                                    <div class="card-title">Determine cuantos dientes debe tener el piñón conducido que requiere su sistema</div>
                                </div>
                                <br />
                                <div class="border-top border-dark border-1">
                                    <div class="col">
                                        ...
                                        <br>
                                        <form action="Calculadora3Servlet" method="post">
                                        <div class="mx-5 my-3">
                                        ...
                                        <div class="mx-5 my-3">
                                            <label class="text-left">Ingrese # de RPM deseadas en el eje conducido</label>
                                            <input name="rpmDeseadas" id="rpmDeseadas" type="number" class="form-control">
                                        </div>
                                        <div class="mx-5 my-3">
        ...
        <script>
            ...
            var rpmDeseadas = document.querySelector('#rpmDeseadas');
            var pinonMotriz = document.querySelector('#pinonMotriz');
            var resultado = document.querySelector('span');

            function calcular() {
                resultadoOperacion = Math.round(parseInt(pinonMotriz.value) * parseInt(rpmMotor.value) / parseInt(rpmDeseadas.value));
                resultado.innerHTML = "Usted necesita un piñón conducido de " + resultadoOperacion + " dientes";
            }
        </script>
        <!--   Core JS Files   -->
