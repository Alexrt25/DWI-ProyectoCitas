            ...
            <div class="page-inner">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <br />
                            <h4 class="page-title text-center"><strong>Calculadora de número de dientes del piñón motriz</strong> </h4>
                            <div class="card-header text-center">
                                <div class="align-items-center">
                                    <div class="card-title">Determine cuantos dientes debe tener el piñón motriz que requiere su sistema</div>
                                </div>
                                <br />
                                <div class="border-top border-dark border-1">
                                    <div class="col">
                                        ...
                                        <br>
                                        <form action="Calculadora2Servlet" method="post">
                                        <div class="mx-5 my-3">
