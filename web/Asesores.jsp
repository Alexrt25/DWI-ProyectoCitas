<%-- 
    Document   : Asesores
    Created on : 17/11/2022, 03:28:48 PM
    Author     : Lisbet Moron
--%>
        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header mt-5">
                    <h4 class="page-title ml-3">Asesores</h4>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title my-3">Listado de Asesores</h4>
                                </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title"> Registrar Asesor </h3> 
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <c:if test="${not empty requestScope.mensaje}">
                                                ...
                                                Swal.fire({
                                                    ...
                                                    text: 'El asesor ya se encuentra activo!',
                                                })
