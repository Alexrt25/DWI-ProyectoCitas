<%-- 
    Document   : AsesoresEditar
    Created on : 5 dic. 2022, 20:42:34
    Author     : lisbetmoron
--%>
        ...
        <div class="content">
            ...
            <div class="page-inner">
                ...
                <div class="page-header mt-5">
                    <h4 class="page-title ml-3">Editar Asesores</h4>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title my-3">Editar Asesores</h4>
                                </div>
            ...
            boton.addEventListener("click", (event) => {
                ...
                Swal.fire({
                    ...
                    text: 'Asesor fue actualizado con éxito!',
