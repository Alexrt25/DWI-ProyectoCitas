...
public class Usuario2DAO {
    ...
    public Usuario2 validar(String correo, String contrasenia){
        ...
        public Usuario2 validarCorreo(String correo){
        Usuario2 us=new Usuario2();
    ...
    public int agregar(Usuario2 us){
        int idUsuario =0;
    ...
    public Usuario2 listarId(int id){
        Usuario2 us=new Usuario2();
