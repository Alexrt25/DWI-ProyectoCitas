        ...
        <div class="content">
            ...
            <div class="page-inner">
                ...
                <div class="page-header mt-5">
                    <h4 class="page-title ml-3">Editar Pacientes</h4>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title my-3">Editar Pacientes</h4>
                                </div>
                            ...
                            <div class="card-body">
                                <form id="formRegistro"  action="Validar"  method="get" >
                                    ...
                                    <button type="submit" hidden="true" id="accion" name="accion" value="ActualizarPaciente"  class="btn btn-primary">Actualizar</button>
