                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="formRegistro"  action="Validar"  method="get" >
                                    ...
                                    <button type="submit" hidden="true" id="accion" name="accion" value="ActualizarCitas" class="btn btn-primary"></button>
        ...
        <script>
                                                ...
                                                boton.addEventListener("click", (event) => {
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        text: 'La cita fue cambiada con éxito!',
